# Generated by Django 4.2.27 on 2025-12-14 17:52
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('host', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='listings', to='app.user', verbose_name='Chủ nhà')),
            ],
            options={
                'verbose_name': 'Chỗ ở',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('host', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='policy', to='app.user')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, related_name='complaints', to='app.user', verbose_name='Người khiếu nại')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='booking',
            name='user',
            field=models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, related_name='bookings', to='app.user', verbose_name='Khách'),
        ),
        migrations.CreateModel(
            name='ListingAmenity',
            fields=[
